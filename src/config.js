...
const { networkCidr, parseSubnet } = require('./lib/Subnet');
...
module.exports.WG_SUBNET = parseSubnet(module.exports.WG_DEFAULT_ADDRESS);
...
iptables -t nat -A POSTROUTING -s ${networkCidr(module.exports.WG_DEFAULT_ADDRESS)} -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
iptables -t nat -D POSTROUTING -s ${networkCidr(module.exports.WG_DEFAULT_ADDRESS)} -o ${module.exports.WG_DEVICE} -j MASQUERADE;
